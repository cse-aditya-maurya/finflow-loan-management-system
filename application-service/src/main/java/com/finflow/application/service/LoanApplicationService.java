...
public class LoanApplicationService {
    ...
    // Admin email to receive new loan submission alerts
    private static final String ADMIN_EMAIL = "mishraamresh2345@gmail.com";

    private void publishLoanEvent(LoanApplication app, String eventType, String message) {
        try {
            UserProfileResponse profile = authClient.getUserProfileById(app.getUserId());
            String userEmail = (profile != null && profile.getEmail() != null)
                    ? profile.getEmail()
                    : ("user" + app.getUserId() + "@example.com");
            ...
            com.finflow.application.dto.LoanEvent event = com.finflow.application.dto.LoanEvent.builder()
                    ...
                    .name(userName)
                    .message(message)
                    .loanType(app.getLoanType() != null ? app.getLoanType().name() : "N/A")
                    .loanAmount(app.getAmount())
