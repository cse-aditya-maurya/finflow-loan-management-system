...
public class AdminController {
    ...
    // ===============================
    @Operation(summary = "View document details (Admin only)")
    @SecurityRequirement(name = "bearerAuth")
    ...
    public Object viewDocument(
        ...
        return service.viewDocument(docId, header);
    }
    ...
    public Object getAllUsers(
        ...
        return service.getAllUsers(header);
    }

    // ===============================
    // 👤 GET USER BY ID
    // ===============================
    @Operation(summary = "Get user by ID with applications (Admin only)")
    @SecurityRequirement(name = "bearerAuth")
    ...
    public Object getUserById(
        ...
        return service.getUserById(userId, header);
    }
    ...
    public Object getStatistics(
        ...
        return service.getStatistics(header);
    }
}